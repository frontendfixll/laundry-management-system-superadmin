    ...
    <div className="space-y-6 p-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatCurrency(platformAnalytics?.overview.platformRevenue || 0)}</div>
                ...
                {platformAnalytics?.topTenanciesByRevenue?.length ? (
                  platformAnalytics.topTenanciesByRevenue.map((t, i) => (
                    <TableRow key={t._id}>
                      ...
                      <TableCell className="text-right">
                        <Badge variant={i === 0 ? 'default' : 'secondary'}>{formatCurrency(t.revenue)}</Badge>
                      </TableCell>
                    </TableRow>
                  ))
                ) : (
